...
const CustomTooltip = ({ active, payload, label }: any) => {
    ...
    return (
        <div
            ...
            <p style={{ margin: "0 0 6px", fontWeight: 700, color: "#111827" }}>
                {label}
            </p>
            {payload.map((p: any, i: number) => (
                <p
                    key={i}
                    style={{ margin: "2px 0", color: p.color }}>
                    {p.name}: {Number(p.value).toLocaleString("ar-EG")} ج.م
                </p>
            ))}
        </div>
    );
        ...
        <div style={{ fontFamily: "Cairo, sans-serif" }}>
            ...
            <div style={{ padding: 24 }}>
                ...
                <div
                    ...
                    <StatCard
                        title="مبيعات اليوم"
                        value={fmt(dashboardStats.todaySales ?? 0)}
                        change={12.5}
                        icon={ShoppingBag}
                        color="#10B981"
                    ...
                    <StatCard
                        title="مشتريات اليوم"
                        value={fmt(dashboardStats.todayPurchases ?? 0)}
                        change={-3.2}
                        icon={Truck}
                        color="#3B82F6"
                    ...
                    <StatCard
                        title="قيمة المخزون"
                        value={fmt(dashboardStats.inventoryValue ?? 0)}
                        icon={Package}
                        color={GOLD}
                    ...
                    <StatCard
                        title="الرصيد النقدي"
                        value={fmt(dashboardStats.cashBalance ?? 0)}
                        change={8.1}
                        icon={DollarSign}
                        color="#8B5CF6"
                    ...
                    <StatCard
                        ...
                        subtitle="مصروفات وطلبات"
                    />
                    <StatCard
                        title="إيرادات الشهر"
                        value={fmt(dashboardStats.monthlyRevenue ?? 0)}
                        change={18.4}
                        icon={BarChart2}
                        color="#10B981"
                        ...
                        <ResponsiveContainer
                            ...
                            <AreaChart data={salesChart}>
                                ...
                                <YAxis
                                    ...
                                    tickFormatter={(v) => v / 1000 + "ك"}
                                />
                                <Tooltip content={<CustomTooltip />} />
                                <Legend
                                    formatter={(v) =>
                                        v === "sales" ? "المبيعات" : "المشتريات"
                                    }
                                    wrapperStyle={{
                                        fontFamily: "Cairo, sans-serif",
                                        fontSize: 12,
